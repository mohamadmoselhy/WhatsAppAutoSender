...
from config import load_config  # Imports the folder path to be monitored.

ConfigDic=load_config()
folder_to_watch=ConfigDic.get("Folder to Watch")
...
while True:
    try:
        ...
        print(error_msg)
        raise "[Fetal]RuntimeError(error_msg)" from e  # Rethrow for higher-level handling.
